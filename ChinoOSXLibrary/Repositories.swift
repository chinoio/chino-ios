...
open class Repositories: ChinoBaseAPI{
    ...
    public func getRepository(repository_id id: String, completion: @escaping (_ repository: Repository?) -> ()) {
    ...
    public func listRepositories(completion: @escaping (_ repositories: GetRepositoriesResponse?) -> ()) {
    ...
    public func listRepositories(offset: Int, limit: Int, completion: @escaping (_ repositories: GetRepositoriesResponse?) -> ()) {
    ...
    public func createRepository(description: String, completion: @escaping (_ repository: Repository?) -> ()) {
    ...
    public func updateRepository(repository_id id: String, description: String, completion: @escaping (_ repository: Repository?) -> ()) {
