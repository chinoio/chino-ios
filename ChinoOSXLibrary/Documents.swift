...
open class Documents: ChinoBaseAPI{
    ...
    public func getDocument(document_id id: String, completion: @escaping (_ schema: Document?) -> ()) {
    ...
    public func listDocumentsWithContent(schema_id id: String, completion: @escaping (_ schemas: GetDocumentsResponseFullContent?) -> ()) {
    ...
    public func listDocumentsWithoutContent(schema_id id: String, completion: @escaping (_ schemas: GetDocumentsResponse?) -> ()) {
    ...
    public func listDocumentsWithContent(schema_id id: String, offset: Int, limit: Int, completion: @escaping (_ schemas: GetDocumentsResponseFullContent?) -> ()) {
    ...
    public func listDocumentsWithoutContent(schema_id id: String, offset: Int, limit: Int, completion: @escaping (_ schemas: GetDocumentsResponse?) -> ()) {
    ...
    public func createDocument(schema_id id: String, content: NSDictionary, completion: @escaping (_ schema: CreateDocumentResponse?) -> ()) {
    ...
    public func updateDocument(document_id id: String, content: NSDictionary, completion: @escaping (_ schema: CreateDocumentResponse?) -> ()) {
        let request = CreateDocumentRequest(content: content)
    ...
    public func deleteDocument(document_id id: String, force: Bool, completion: @escaping (_ result: String?) -> ()) {
